...
<head>
    ...
    <title>Clinica Dental Dra. Daniela Arce</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class=" sidebar-brand-text mx-3">Clinica Dental Dra. Daniela Arce<sup></sup>
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Ver Opciones</h6>
                        <a class="collapse-item" href="../views/pacientes.php">Ver Pacientes</a>
                        <a class="collapse-item" href="../views/expediente.php">Ver Expedientes</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Ver Opciones</h6>
                        <a class="collapse-item" href="../views/grados.php">Citas</a>
                        <a class="collapse-item" href="../views/especialidades.php">Facturas</a>
                    </div>
                </div>
            </li>
